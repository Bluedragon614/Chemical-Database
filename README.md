...
The runnable version of this project is located in "V1.1_Portable"  
- It comes with user documentation as well as premade files to support the running of the program
- compounds.txt and reactions.txt are blank. elements.txt is pre-loaded with all the natural elements in our real-world periodic table
- ELEMENTS_BACKUP.txt is a backup of elements.txt
