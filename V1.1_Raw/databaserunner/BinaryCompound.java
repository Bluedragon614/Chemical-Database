...
public class BinaryCompound extends Chemical {
    ...
    public void setComponent1(FormulaComponent component1) {
        //Checks to make sure that component 1 is always the element with lowest electronegativity
        //Maintains consistency between palindrome compounds
    ...
    public void setComponent2(FormulaComponent component2) {
        //Checks to make sure that component 2 is always the element with highest electronegativity
        //Maintains consistency between palindrome compounds
    ...
    public BinaryCompound(String commonName, double stpDensity, double molarMass, double bp, double mp, String colour, int charge, FormulaComponent component1, FormulaComponent component2) {
        ...
        //Checks for diatomic compounds (2 same elements)
    ...
    //Removes all pointers to the compound from the elements in its composition
    ...
    //Formats compound fields for file output
