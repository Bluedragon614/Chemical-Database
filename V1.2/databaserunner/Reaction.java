...
public class Reaction {
    ...
    //# of decimals to determine molar mass to
    ...
    public Reaction(int id, Element reactant1, Element reactant2) {
        ...
        //checks if the reactants exist
        if (this.reactant1 != null && this.reactant2 != null)
            this.product = this.react(); 

        //if reaction is valid, set up product & pointers
    ...
    //Reaction constructor for when product is known
    ...
    //remove all pointers of reactions component chemicals
    ...
    //Algorithm to determine reaction result
    ...
    //Fixes floating point error in molar mass calc
    ...
    //private method to determine GCF (Helper Function)
    ...
    //Formats fields of reaction for file output
