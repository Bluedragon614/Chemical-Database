/*
    ...
    Course: ICS4U1
    Teacher: Mrs. Lam
    Description: To store the database and act as a link between GUI and the database itself
*/
...
public class DatabaseGUI {
    ...
    //restarts the database (opens startPage)
    public void restart() {
        this.startPage.start(this.startPage);
    }
