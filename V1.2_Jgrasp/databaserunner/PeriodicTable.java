...
public class PeriodicTable {
    ...
    //Defaults
    public static final Element UNKNOWN_ELEMENT = new Element(Element.DEFAULT_COMMON_NAME, Element.DEFAULT_DENSITY, Element.DEFAULT_MOLAR_MASS, Element.DEFAULT_STATE_CHANGE_TEMP, Element.DEFAULT_STATE_CHANGE_TEMP, Element.DEFAULT_COLOUR, NuclearProperties.DEFAULT_PROTONS, NuclearProperties.DEFAULT_NEUTRONS, NuclearProperties.DEFAULT_IONIZATION_ENERGY, NuclearProperties.MIN_ELECTRONEGATIVITY, Element.DEFAULT_ATOMIC_SYMBOL);
    ...
    //Recursive method to determine # of elements in a given period
