...
public class ChemicalDatabase {
    ...
    public boolean load(String elementsFile, String binaryCompoundsFile, String reactionsFile, int firstValence, int increment, boolean periodicTrendsChanged) {
        ...
        try {
            ...
            System.out.println(DatabaseGUI.WARNING + DatabaseGUI.ELEMENTS_FILE + DatabaseGUI.WARNING_NOT_FOUND);
            noElements = true;
        }catch(NumberFormatException nfx) {
            System.out.println(DatabaseGUI.ERROR + DatabaseGUI.ERROR_BOTCHED_FILE + DatabaseGUI.ELEMENTS_FILE);
        }
        ...
        if (!noElements) {
            try{
                ...
                System.out.println(DatabaseGUI.WARNING + DatabaseGUI.BINARY_COMPOUNDS_FILE + DatabaseGUI.WARNING_NOT_FOUND);
            }catch(NullPointerException npx){
                System.out.println(DatabaseGUI.ERROR + DatabaseGUI.ERROR_FILE_MISMATCH_1 + DatabaseGUI.BINARY_COMPOUNDS_FILE + DatabaseGUI.ERROR_FILE_MISMATCH_2 + DatabaseGUI.ELEMENTS_FILE_NAME);
            }catch(NumberFormatException nfx) {
                System.out.println(DatabaseGUI.ERROR + DatabaseGUI.ERROR_BOTCHED_FILE + DatabaseGUI.ELEMENTS_FILE);
            }
            ...
            try{
                ...
                System.out.println(DatabaseGUI.WARNING + DatabaseGUI.REACTIONS_FILE + DatabaseGUI.WARNING_NOT_FOUND);
            } catch(NullPointerException npx){
                System.out.println(DatabaseGUI.ERROR + DatabaseGUI.ERROR_FILE_MISMATCH_1 + DatabaseGUI.REACTIONS_FILE + DatabaseGUI.ERROR_FILE_MISMATCH_2 + DatabaseGUI.ELEMENTS_FILE_NAME);
            } catch(NumberFormatException nfx) {
                System.out.println(DatabaseGUI.ERROR + DatabaseGUI.ERROR_BOTCHED_FILE + DatabaseGUI.ELEMENTS_FILE);
            }
        }
